  ...
  return (
    <div
      ...
      className={`relative aspect-square rounded-3xl overflow-hidden border border-dashed cursor-pointer transition-all duration-300 group ${
        isDragging ? 'border-pink-500 bg-pink-500/10' : 'border-gray-800/50 hover:border-pink-500/30'
      }`}
    >
      <input
        type="file"
          ...
          <>
            ...
            <div className="flex flex-col items-center justify-center space-y-2 md:space-y-3 z-10 w-full px-1 p-6">
              ...
              <div className="w-full">
                <p className="text-white font-semibold text-lg md:text-2xl tracking-tight whitespace-nowrap drop-shadow-md">Envie uma foto</p>
